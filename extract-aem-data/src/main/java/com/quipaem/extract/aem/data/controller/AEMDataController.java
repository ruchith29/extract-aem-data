...
public class AEMDataController {
    ...
    public ResponseEntity<ObjectNode> postData(@RequestParam String sitePath,@RequestParam String clientName) throws IOException {
        ...
        try {
            ...
            return new ResponseEntity<>(objectMapper.convertValue(aemDataService.storeData(aemConnection.getConnection(url),clientName),ObjectNode.class),HttpStatus.OK);
        }
        catch (Exception exception){
            Map<String,String> response=new LinkedHashMap<>();
            response.put("status","failed");
    ...
    public ResponseEntity<ObjectNode> updateData(@RequestBody ObjectNode siteData,@RequestParam String clientName){
        ...
        return new ResponseEntity<>(objectMapper.convertValue(aemDataService.updateData(siteData,clientName),ObjectNode.class),HttpStatus.OK);
    }
